                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="celular" id="celular"
                                ...
                                required placeholder="9 dígitos, comienza con 9">
                            @error('celular')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <select name="estado_user_id" id="estado_user_id"
                                ...
                                @foreach ($estados as $estado)
                                    <option value="{{ $estado->id }}"
                                        {{ old('estado_user_id') == $estado->id ? 'selected' : '' }}>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="horarios[{{ $index }}][dia_semana]"
                                                                    class="form-control @error('horarios.' . $index . '.dia_semana') is-invalid @enderror"
                                                                    required>
                                                                    <option value="">Seleccione un día</option>
                                                                    @foreach ($diasSemana as $key => $dia)
                                                                        <option value="{{ $key }}"
                                                                            {{ $horario['dia_semana'] == $key ? 'selected' : '' }}>
                                                                            {{ $dia }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                <label>Turno*</label>
                                                                <select name="horarios[{{ $index }}][turno_id]"
                                                                    class="form-control @error('horarios.' . $index . '.turno_id') is-invalid @enderror"
                                                                    required>
                                                                    <option value="">Seleccione un turno</option>
                                                                    @foreach ($turnos as $turno)
                                                                        <option value="{{ $turno->id }}"
                                                                            {{ $horario['turno_id'] == $turno->id ? 'selected' : '' }}>
                                                                            {{ $turno->nombre_turno }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <label>&nbsp;</label>
                                                                <button type="button"
                                                                    class="btn btn-danger btn-block remove-horario">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="celular_alterno" id="celular_alterno"
                                ...
                                value="{{ old('celular_alterno') }}" placeholder="9 dígitos, comienza con 9">
