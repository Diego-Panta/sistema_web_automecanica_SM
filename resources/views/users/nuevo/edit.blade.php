                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="codigo_trabajador" id="codigo_trabajador" 
                                   ...
                                   value="{{ old('codigo_trabajador', $user->laborale->codigo_trabajador ?? '') }}" required>
                            ...
                            <select name="estado_user_id" id="estado_user_id" 
                                ...
                                @foreach($estados as $estado)
                                    <option value="{{ $estado->id }}" 
                                        {{ old('estado_user_id', $user->laborale->estado_user_id ?? '') == $estado->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="fecha_contratacion_inicio" id="fecha_contratacion_inicio" 
                                           ...
                                           value="{{ old('fecha_contratacion_inicio', $user->laborale->fecha_contratacion_inicio ?? '') }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="fecha_contratacion_fin" id="fecha_contratacion_fin" 
                                           ...
                                           value="{{ old('fecha_contratacion_fin', $user->laborale->fecha_contratacion_fin ?? '') }}">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div id="horariosContainer">
                                    @php
                                        $existingHorarios = old('horarios', $user->laborale && $user->laborale->horarios ? $user->laborale->horarios->toArray() : []);
                                    @endphp
                                    
                                    @forelse($existingHorarios as $index => $horario)
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="horarios[{{ $index }}][dia_semana]" class="form-control @error('horarios.'.$index.'.dia_semana') is-invalid @enderror" required>
                                                                ...
                                                                @foreach($diasSemana as $key => $dia)
                                                                    <option value="{{ $key }}" 
                                                                        {{ (isset($horario['dia_semana']) ? $horario['dia_semana'] : $horario->dia_semana ?? '') == $key ? 'selected' : '' }}>
                                                                        {{ $dia }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                            ...
                                                            <select name="horarios[{{ $index }}][turno_id]" class="form-control @error('horarios.'.$index.'.turno_id') is-invalid @enderror" required>
                                                                ...
                                                                @foreach($turnos as $turno)
                                                                    <option value="{{ $turno->id }}" 
                                                                        {{ (isset($horario['turno_id']) ? $horario['turno_id'] : $horario->turno_id ?? '') == $turno->id ? 'selected' : '' }}>
                                                                        {{ $turno->nombre_turno }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="celular_alterno" id="celular_alterno" 
                                   ...
                                   value="{{ old('celular_alterno', $user->celular_alterno) }}"
                                   placeholder="9 dígitos, comienza con 9">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="email_personal" id="email_personal" 
                                   ...
                                   value="{{ old('email_personal', $user->email_personal) }}">
...
@section('js')
    <script>
        let horarioIndex = {{ count($existingHorarios) }};
